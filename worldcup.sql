...
--
-- Name: games fk_games_teams_2; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_games_teams_2 FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
